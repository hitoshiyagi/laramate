    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="card mt-4" id="element-card" style="display:none;">
                <div class="card-header">要素群生成</div>
                <div class="card-body">
                    <form id="element-form">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="button" class="btn btn-success" id="preview-elements">生成する</button>
                            </div>
                        </div>
                    </form>
                    ...
                    <div id="generation-result" class="mt-4" style="display:none;">
                        <h5>生成結果プレビュー</h5>
                        <div id="result-table" class="p-3 bg-light border rounded"></div>
